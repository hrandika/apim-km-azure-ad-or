...
public class AzureADClient extends AbstractKeyManager {
    ...
    public void loadConfiguration(KeyManagerConfiguration configuration) throws APIManagementException {
        ...
        appClientId = (String) this.configuration.getParameter(AzureADConstants.AD_APP_CLIENT_ID);
        appClientSecret = (String) this.configuration.getParameter(AzureADConstants.AD_APP_CLIENT_SECRET);
        ...
        AzureADRequestInterceptor appInterceptor = new AzureADRequestInterceptor(tokenEndpoint, appClientId,
                appClientSecret);
