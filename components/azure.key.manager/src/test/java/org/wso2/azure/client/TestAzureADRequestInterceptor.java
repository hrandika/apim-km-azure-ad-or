...
public class TestAzureADRequestInterceptor {
    ...
    @BeforeEach
    public void before() {
        this.adRequestInterceptor = new AzureADRequestInterceptor(AzureAdValues.tokenEndpoint, AzureAdValues.clientId,
    ...
    public void itShouldAppendTokenToHeader() {
        ...
        verify(requestTemplate).header(eq(key), startsWith(APIConstants.AUTHORIZATION_BEARER));
    }
