...
public class TestAzureADClient {
    ...
    public void setUp() throws APIManagementException {
        ...
        configuration.addParameter(AzureADConstants.AD_APP_CLIENT_ID, AzureAdValues.clientId);
        configuration.addParameter(AzureADConstants.AD_APP_CLIENT_SECRET, AzureAdValues.clientSecret);

        configuration.addParameter(AzureADConstants.GRAPH_API_ENDPOINT, AzureADConstants.GRAPH_API_ENDPOINT_VALUE);
        configuration.addParameter(APIConstants.KeyManager.TOKEN_ENDPOINT, AzureAdValues.tokenEndpoint);
    ...
    @Test
    public void itShouldGetClientInformation() throws APIManagementException, InterruptedException {
        String clientId = this.createAndGetClientId();
    ...
    @Test
    public void itShouldUpdateCreatedApplication() throws APIManagementException, InterruptedException {
